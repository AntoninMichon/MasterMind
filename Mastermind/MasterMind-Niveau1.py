...
def user(tab, verif) :
    ...
    if not verif[0] :
        col1 = False
        while not col1 :
            user = input("\nEntrer votre première couleur => ").lower()
            if user in tab :
                col1 = True
            else :
    ...
    if not verif[1] :
        col2 = False
        while not col2 :
            user = input("\nEntrer votre seconde couleur => ").lower()
            if user in tab :
                col2 = True
            else :
                print("Vous n'avez pas rentrer un couleur, ou celle ci est mal orthographiée ou indisponible.")
    ...
    if not verif[2] :
        col3 = False
        while not col3 :
            user = input("\nEntrer votre troisième couleur => ").lower()
            if user in tab :
                col3 = True
            else :
                print("Vous n'avez pas rentrer un couleur, ou celle ci est mal orthographiée ou indisponible.")
    ...
    if not verif[3] :
        col4 = False
        while not col4 :
            user = input("\nEntrer votre quatrième couleur => ").lower()
            if user in tab :
                col4 = True
            else :
                print("Vous n'avez pas rentrer un couleur, ou celle ci est mal orthographiée ou indisponible.")
    ...
    if not verif[4] :
        col5 = False
        while not col5 :
            user = input("\nEntrer votre cinquième couleur => ").lower()
            if user in tab :
                col5 = True
            else :
                print("Vous n'avez pas rentrer un couleur, ou celle ci est mal orthographiée ou indisponible.")
